...
function App() {
  ...
  const {numberCar, listCard, removeCard, addCard} = useCard()


  return (
    <BrowserRouter>
        <Nav number={numberCar} listCard={listCard} removeCar={removeCard} /> 
        <main  className=" w-full flex flex-col justify-between min-h-[90vh] font-inter px-[10%] lg:px-[20%] 2xl:px-[25%] pt-5 relative">     
          <Routes>
